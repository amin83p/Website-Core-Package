...
/**
 * Rolling classes: final grade uses only attendance + assignments (sessionsâ€™ gradebooks,
...
function assertRollingClassHasAllowedProgramOrThrow(classPayload) {
    ...
    if (!hasProgram) {
        throw new Error('Rolling classes require at least one program on the Program Terms tab. Add a program without a term, or a full programâ€“term pair. This is required for academic ledger and enrollment defaults.');
    }
}
