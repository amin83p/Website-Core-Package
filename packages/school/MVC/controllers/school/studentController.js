...
exports.listStudents = async (req, res) => {
    try {
        ...
        const canCreateProgramRegistrations = canCreateStudents
            ? await canCreateOrgScopedItem(req.user, { scopeLabel: 'program registrations' })
            : false;
        ...
        res.render('school/student/studentList', {
            ...
            canCreateProgramRegistrations: Boolean(canCreateProgramRegistrations),
            print: true,
            pagination,
            filters: req.query,
