...
const LABEL_FIELDS = Object.freeze({
  ...
  overallReportTemplates: ['title'],
  overallReportInstances: ['title', 'overallTemplateId'],
  ...
  bookAssignments: ['classId'],
  bookCoveringReports: ['classId', 'teacherId', 'notes'],
...
const SCHOOL_DATA_MAINTENANCE_CATALOG = Object.freeze([
  ...
  { entityType: 'bookAssignments', label: 'Book Assignments', group: 'library', collectionName: 'schoolBookAssignments', deleteStrategy: DELETE_STRATEGIES.REMOVE, supportsClearAll: true },
  { entityType: 'bookCoveringReports', label: 'Book Covering Reports', group: 'library', collectionName: 'schoolBookCoveringReports', deleteStrategy: DELETE_STRATEGIES.REMOVE, supportsClearAll: true },
  ...
  { entityType: 'overallReportTemplates', label: 'Overall Report Templates', group: 'reports', collectionName: 'schoolOverallReportTemplates', deleteStrategy: DELETE_STRATEGIES.REMOVE, supportsClearAll: false },
  { entityType: 'overallReportInstances', label: 'Overall Report Instances', group: 'reports', collectionName: 'schoolOverallReportInstances', deleteStrategy: DELETE_STRATEGIES.REMOVE, supportsClearAll: true },
...
function resolveListFields(entityType) {
  ...
  const extras = {
    ...
    overallReportTemplates: ['title', 'version'],
    overallReportInstances: ['title', 'overallTemplateId', 'revision'],
