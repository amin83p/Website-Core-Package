...
const SCHOOL_SECTIONS = Object.freeze({
  ...
  SCHOOL_REPORT_HUB: 'SCHOOL_REPORT_HUB',
  SCHOOL_SETTINGS: 'SCHOOL_SETTINGS',
  SCHOOL_STUDENTS: 'SCHOOL_STUDENTS',
  SCHOOL_FUNDERS: 'SCHOOL_FUNDERS',
  ...
  SCHOOL_LIBRARY_COPIES: 'SCHOOL_LIBRARY_COPIES',
  SCHOOL_LIBRARY_PATRONS: 'SCHOOL_LIBRARY_PATRONS',
  SCHOOL_LIBRARY_CIRCULATION: 'SCHOOL_LIBRARY_CIRCULATION',
  SCHOOL_LIBRARY_POLICIES: 'SCHOOL_LIBRARY_POLICIES',
  SCHOOL_LIBRARY_LOCATIONS: 'SCHOOL_LIBRARY_LOCATIONS',
  SCHOOL_TIMESHEET_PERIODS: 'SCHOOL_TIMESHEET_PERIODS',
  SCHOOL_TIMESHEETS: 'SCHOOL_TIMESHEETS',
  SCHOOL_TIMESHEET_MANAGEMENT: 'SCHOOL_TIMESHEET_MANAGEMENT',
  ...
  SCHOOL_REPORTS_OVERALL_TEMPLATE: 'SCHOOL_REPORTS_OVERALL_TEMPLATE',
  SCHOOL_REPORTS_OVERALL_INSTANCES: 'SCHOOL_REPORTS_OVERALL_INSTANCES',
  SCHOOL_REPORTS_OVERALL_MANAGEMENT: 'SCHOOL_REPORTS_OVERALL_MANAGEMENT',
  ...
  SCHOOL_DATA_MAINTENANCE: 'SCHOOL_DATA_MAINTENANCE',
  ...
  SCHOOL_TEACHING_OUTLINES: 'SCHOOL_TEACHING_OUTLINES'
});

const SCHOOL_ROLES = Object.freeze({
  STUDENT: 'school_student',
  FUNDER: 'school_funder',
...
const SCHOOL_UPLOAD_FOLDERS = Object.freeze({
  ...
  BOOK_COVER: 'school.bookCover',
  BOOK_PDF: 'school.bookPdf'
});
