(function () {
  const root = document.querySelector('[data-report-hub]');
  if (!root) return;
  ...
  const els = {
    ...
    title: document.getElementById('schoolReportHubTitle'),
    eyebrow: document.getElementById('schoolReportHubEyebrow'),
    meta: document.getElementById('schoolReportHubMeta'),
    list: document.getElementById('schoolReportHubList'),
    status: document.getElementById('schoolReportHubStatus'),
    search: document.getElementById('schoolReportHubSearch'),
    limit: document.getElementById('schoolReportHubLimit'),
    refreshCurrent: document.getElementById('schoolReportHubRefreshCurrent'),
    openDirectory: document.getElementById('schoolReportHubOpenDirectory'),
    collapseSidebar: document.getElementById('schoolReportHubCollapseSidebar')
  };
  ...
  function updateHeader(result) {
    ...
    if (els.title) els.title.textContent = module ? module.label : 'School Report Hub';
    if (els.meta) {
  ...
  async function loadCurrent(options) {
    ...
    try {
      const response = await fetch(`/school/report-hub/api/list?${query.toString()}`, {
