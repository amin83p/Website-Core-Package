...
const { requireCoreModule, resolveCoreRoot } = require('../benchpathCoreModuleResolver');
...
const DEFAULT_REFERENCE_DIR = path.join(resolveCoreRoot(), 'data/benchpath/reference');
