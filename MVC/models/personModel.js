...
const AUDIENCE_ALIAS_TO_CANONICAL = Object.freeze({
  ...
  schoolstaff: 'school_staff',
  schoolstaffs: 'school_staff',
  pte_student: 'pte_student',
  pte_students: 'pte_student',
  ptestudent: 'pte_student',
  ptestudents: 'pte_student',
  pte_student_public: 'pte_student_public',
  pte_students_public: 'pte_student_public',
  ptestudentpublic: 'pte_student_public',
  ptestudentspublic: 'pte_student_public',
  pte_teacher: 'pte_teacher',
  pte_teachers: 'pte_teacher',
  pteteacher: 'pte_teacher',
  pteteachers: 'pte_teacher',
  pte_instructor: 'pte_instructor',
  pte_instructors: 'pte_instructor',
  pteinstructor: 'pte_instructor',
  pteinstructors: 'pte_instructor',
  pte_trainer: 'pte_trainer',
  pte_trainers: 'pte_trainer',
  ptetrainer: 'pte_trainer',
  ptetrainers: 'pte_trainer',
...
const AUDIENCE_CANONICAL_EXTRA = Object.freeze({
  ...
  pte_student: ['pte_students'],
  pte_teacher: ['pte_teachers'],
  pte_instructor: ['pte_instructors'],
  pte_trainer: ['pte_trainers'],
