...
const { queueWrite } = require('../fileQueue'); // Ensures file lock safety

const teachersIndexPath = path.join(__dirname, '../../../data/school/teacher_schedules.json');
const studentsIndexPath = path.join(__dirname, '../../../data/school/student_enrollments.json');
