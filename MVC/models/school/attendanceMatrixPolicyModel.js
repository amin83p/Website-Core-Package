...
const { normalizeMongoDocument } = require('../../repositories/backend/mongoRepositoryUtils');

const dataPath = path.join(__dirname, '../../../data/school/attendanceMatrixPolicy.json');
