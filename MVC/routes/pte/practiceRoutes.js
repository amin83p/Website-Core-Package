...
const ctrl = require('../../controllers/pte/practiceController');
const mockCtrl = require('../../controllers/pte/mockExamController');
const upload = require('../../middleware/upload');
const pteUploadContext = require('../../middleware/pteUploadContextMiddleware');
const { requireAuth } = require('../../middleware/authMiddleware');
const { requireAccess } = require('../../middleware/accessMiddleware');
const { trackActionState } = require('../../middleware/actionStateMiddleware');
const { resolveActivityQuotaPolicy } = require('../../middleware/activityQuotaMiddleware');
...
router.post('/mock-exams/api/runtime/:sessionId/finish',
  requireAccess(SECTIONS.PTE_MOCK_EXAMS, OPERATIONS.UPDATE),
  trackActionState(SECTIONS.PTE_MOCK_EXAMS, OPERATIONS.UPDATE, RUNTIME_ACTION_STATE_OPTIONS),
