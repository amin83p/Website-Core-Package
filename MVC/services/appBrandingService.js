...
const PUBLIC_MENU_ENDPOINT_OPTIONS = Object.freeze([
  ...
  { label: 'PTE Test', href: '/pte', icon: 'bi-mortarboard', visibility: 'all', target: '_self', category: 'PTE' },
  { label: 'PTE Test Info', href: '/pte/test-info', icon: 'bi-info-square', visibility: 'all', target: '_self', category: 'PTE' },
  { label: 'Join PTE Practice', href: '/pte/join', icon: 'bi-person-plus', visibility: 'all', target: '_self', category: 'PTE' },
  { label: 'PTE Packages', href: '/pte/packages', icon: 'bi-box-seam', visibility: 'all', target: '_self', category: 'PTE' },
