...
test('school timesheet management section supports route read-all access', () => {
  ...
  assert.ok(operationIds(manifestSection).includes('OP1012'), 'manifest section should support EXPORT');
  ...
  assert.ok(operationIds(localSection).includes('OP1012'), 'local section should support EXPORT');
});
...
test('timesheet mongo seed repairs both timesheet sections and symbol metadata', () => {
  ...
  assert.match(seedSource, /operations: \['OP1002', 'OP1003', 'OP1005', 'OP1001', 'OP1004', 'OP1012'\]/);
  assert.match(seedSource, /operations: \['OP1002', 'OP1003', 'OP1005', 'OP1006', 'OP1012'\]/);
